...
export interface AmazonProduct {
  ...
  /**
   * Kitap kategorisi için fiyatlandırma kuralları
   */
  function calculateBookPrice(price: number, salesRank: number): PricingResult {
    ...
    if (salesRank <= 1000000) {
      if (price >= 24 && price <= 30) {
        return { accepted: true, ourPrice: 1, category: 'books', priceRange: "$24-30", rankRange: "≤ 1M" };
      }
      if (price >= 31 && price <= 40) {
        return { accepted: true, ourPrice: 2, category: 'books', priceRange: "$31-40", rankRange: "≤ 1M" };
      }
      if (price >= 41 && price <= 50) {
        return { accepted: true, ourPrice: 3, category: 'books', priceRange: "$41-50", rankRange: "≤ 1M" };
      }
      if (price >= 51 && price <= 60) {
        return { accepted: true, ourPrice: 4, category: 'books', priceRange: "$51-60", rankRange: "≤ 1M" };
      }
      if (price >= 61 && price <= 90) {
        return { accepted: true, ourPrice: 5, category: 'books', priceRange: "$61-90", rankRange: "≤ 1M" };
      }
      if (price >= 91 && price <= 120) {
        return { accepted: true, ourPrice: 6, category: 'books', priceRange: "$91-120", rankRange: "≤ 1M" };
      }
      if (price > 120) {
        return { accepted: true, ourPrice: 7, category: 'books', priceRange: "$120+", rankRange: "≤ 1M" };
      }
    ...
    if (salesRank <= 2000000) {
      if (price >= 51 && price <= 60) {
        return { accepted: true, ourPrice: 2, category: 'books', priceRange: "$51-60", rankRange: "1M-2M" };
      }
      if (price >= 61 && price <= 90) {
        return { accepted: true, ourPrice: 3, category: 'books', priceRange: "$61-90", rankRange: "1M-2M" };
      }
      if (price >= 91 && price <= 120) {
        return { accepted: true, ourPrice: 4, category: 'books', priceRange: "$91-120", rankRange: "1M-2M" };
      }
      if (price > 120) {
        return { accepted: true, ourPrice: 5, category: 'books', priceRange: "$120+", rankRange: "1M-2M" };
      }
  ...
  /**
   * CD kategorisi için fiyatlandırma kuralları
   */
  function calculateCDPrice(price: number, salesRank: number): PricingResult {
    ...
    if (salesRank <= 100000) {
      if (price >= 25 && price <= 34) {
        return { accepted: true, ourPrice: 1, category: 'cds', priceRange: "$25-34", rankRange: "≤ 100k" };
      }
      if (price >= 35 && price <= 45) {
        return { accepted: true, ourPrice: 2, category: 'cds', priceRange: "$35-45", rankRange: "≤ 100k" };
      }
      if (price >= 46 && price <= 56) {
        return { accepted: true, ourPrice: 3, category: 'cds', priceRange: "$46-56", rankRange: "≤ 100k" };
      }
      if (price >= 57) {
    ...
    if (salesRank <= 200000) {
      if (price >= 25 && price <= 45) {
        return { accepted: true, ourPrice: 1, category: 'cds', priceRange: "$25-45", rankRange: "100k-200k" };
      }
      if (price >= 46 && price <= 56) {
        return { accepted: true, ourPrice: 2, category: 'cds', priceRange: "$46-56", rankRange: "100k-200k" };
      }
      if (price >= 57) {
