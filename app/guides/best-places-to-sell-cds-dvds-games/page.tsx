...
const COMPARISON = [
  {
    ...
    payment: "PayPal, Venmo, or check by mail",
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Payment timing varies by service. SellBookMedia uses PayPal, Venmo, or check by mail and processes qualifying orders after the shipment is received and inspected.",
  },
  {
          ...
          <section className="mb-14">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-slate-200 bg-white px-5 py-5 shadow-sm">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  Qualifying items are paid by PayPal, Venmo, or check by mail after inspection.
                </p>
              </div>
            </div>
          </section>
