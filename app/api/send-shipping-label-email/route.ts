              ...
              >
                <tr>
                  <td style="padding:18px 20px; font-size:15px; color:#1e40af; line-height:1.5;">
                    ...
                    Once your items arrive and are checked, payment will be processed using the method you selected at checkout — PayPal, Venmo, or check by mail.
                  </td>
                </tr>
              </table>
            </td>
...
Your payment: Once your items arrive and are checked, payment will be processed using the method you selected at checkout — PayPal, Venmo, or check by mail.
