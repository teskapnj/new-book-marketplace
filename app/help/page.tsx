...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "How do I get paid?",
        a: "Payment is processed using the method you selected at checkout — PayPal, Venmo, or check by mail — within 2 business days of inspection. PayPal and Venmo payments are sent electronically, while paper checks are mailed to your shipping address. You'll get an email confirming the details.",
      },
      {
