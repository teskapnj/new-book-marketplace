  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-6 mt-6 sm:mt-10 max-w-3xl mx-auto">
              ...
              <div className="min-h-[78px] sm:min-h-0 rounded-xl sm:rounded-2xl border border-white/15 bg-white/10 px-2 sm:px-5 py-3 sm:py-5 backdrop-blur-sm flex flex-col justify-center">
                ...
                <div className="text-[11px] sm:text-base leading-tight text-blue-200 mt-1">UPC Cash Offers</div>
              </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Direct movie buyback</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">A Simple Way to Sell Used DVDs Online</h2>
          </div>

          <div className="mt-8 prose prose-lg text-gray-600 max-w-none leading-relaxed space-y-5">
            <p>
              Have DVDs, Blu-rays, or 4K movies sitting on a shelf that you no longer watch? SellBookMedia lets you check eligible releases without creating individual marketplace listings, taking product photos, negotiating with buyers, or waiting for someone to purchase each title.
            </p>
            <p>
              Scan or enter the UPC from the exact movie in your hand. If we&apos;re currently buying that release, you&apos;ll see our cash offer instantly. Add qualifying items to your order, submit when the total reaches the minimum, and use the prepaid shipping label we provide.
            </p>
            <p>
              If you want to understand value first, read our{" "}
              <Link href="/guides/how-much-are-used-dvds-worth" className="text-blue-600 font-semibold hover:text-blue-800">
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">From shelf to payment</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">How to Sell Your DVDs for Cash</h2>
            <p className="mt-4 text-xl text-gray-600 max-w-2xl mx-auto">Check the exact release, build your order, and ship accepted movies with a prepaid label.</p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">What we buy</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">What DVDs, Blu-rays &amp; 4K Movies Can I Sell?</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">We buy eligible physical movie releases with readable UPC barcodes based on current demand, resale value, exact edition, and condition.</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {movieFormats.map((format) => (
              <div key={format.name} className="bg-slate-50 p-6 rounded-2xl text-center border border-gray-200">
                <div className="text-4xl mb-3">{format.icon}</div>
                <div className="font-semibold text-gray-800 text-lg">{format.name}</div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">The same movie can have separate DVD, Blu-ray, 4K, steelbook, collector edition, and box-set releases. The UPC helps identify the exact product instead of guessing from the movie title alone.</p>
              <Link href="/guides/media-value-by-barcode" className="inline-flex mt-4 font-semibold text-blue-600 hover:text-blue-800">Learn how barcode value checking works →</Link>
            </div>

            <div className="bg-slate-50 border border-gray-200 rounded-2xl p-6">
              <h3 className="font-bold text-gray-900 text-lg mb-2">Condition &amp; Completeness Still Matter</h3>
              <p className="text-gray-600 leading-relaxed">A matching barcode does not guarantee acceptance. Serious disc damage, missing discs, missing artwork, incomplete sets, mold, or other condition problems can make an item ineligible.</p>
              <Link href="/condition-guidelines" className="inline-flex mt-4 font-semibold text-blue-600 hover:text-blue-800">Review condition guidelines →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Why offers differ</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">What Determines Your DVD&apos;s Cash Offer?</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">The barcode identifies the exact release. The current offer depends on what that release looks like in today&apos;s resale market.</p>
          </div>
          ...
          <div className="mt-8 rounded-2xl border border-blue-100 bg-blue-50 p-6 sm:p-8">
            <div className="grid md:grid-cols-[1fr_auto] gap-5 items-center">
              <div>
                <h3 className="text-xl font-bold text-gray-900">A barcode identifies the release — it does not contain the price</h3>
                <p className="mt-2 text-gray-600 leading-relaxed">Use the UPC to identify the exact DVD, Blu-ray, or 4K release first, then check current demand, format, condition, availability, and the buyback offer for that release.</p>
              </div>
              <Link href="/guides/media-value-by-barcode" className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-5 py-3 font-semibold text-white hover:bg-blue-700 transition-colors">Check Media Value by Barcode →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-10 items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Same movie, different product</p>
              <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">DVD vs. Blu-ray vs. 4K: The Exact Format Matters</h2>
              <div className="mt-5 space-y-4 text-lg leading-relaxed text-gray-600">
                <p>A standard DVD should not be treated as the same product as a Blu-ray or 4K release of the same movie. Each format usually has its own barcode, packaging, supply, and buyer demand.</p>
                <p>Steelbooks, complete series sets, limited editions, collector releases, and upgraded formats can also have very different resale demand from ordinary mass-market copies.</p>
              </div>
              <Link href="/guides/media-value-by-barcode" className="inline-flex mt-6 items-center rounded-xl bg-blue-600 px-6 py-3 font-bold text-white hover:bg-blue-700 transition-colors">See How the Barcode Identifies the Release →</Link>
            </div>

            <div className="rounded-3xl border border-gray-200 bg-slate-50 p-7 sm:p-8">
              <p className="font-semibold text-gray-900">Movie releases worth checking carefully</p>
              <div className="mt-5 space-y-4">
                {["Blu-ray and 4K upgrades", "Steelbooks and collector editions", "Complete TV series and box sets", "Out-of-print or discontinued releases", "Anime, concert, cult, and specialty titles"].map((item) => (
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-blue-950 p-8 sm:p-12 text-white shadow-xl">
            <div className="grid lg:grid-cols-[1.1fr_.9fr] gap-10 items-center">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-300">Before you clear the shelf</p>
                <h2 className="mt-3 text-3xl sm:text-4xl font-bold">Are Old DVDs Worth Anything?</h2>
                <p className="mt-5 text-lg leading-relaxed text-slate-300">Some are, but age alone does not make a DVD valuable. Common releases can stay common for decades, while a discontinued title, complete TV series, unusual box set, anime release, concert DVD, collector edition, or harder-to-find version may deserve a closer look.</p>
                <div className="mt-7 flex flex-wrap gap-3">
                  <Link href="/guides/are-old-dvds-worth-anything" className="inline-flex items-center rounded-xl bg-white px-6 py-3 font-bold text-blue-700 hover:bg-slate-100 transition-colors">Which Old DVDs Can Be Valuable? →</Link>
                  <Link href="/guides/how-much-are-used-dvds-worth" className="inline-flex items-center rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-bold text-white hover:bg-white/10 transition-colors">Read the DVD Value Guide →</Link>
                </div>
              </div>

              <div className="space-y-4">
                {[
                  ["1", "Do not judge by age alone", "Demand, exact edition, format, condition, and availability matter more than simply being old."],
                  ["2", "Check the exact barcode", "Use the UPC from the movie in your hand instead of estimating from the title or cover art."],
                  ["3", "Slow down for unusual releases", "Box sets, steelbooks, discontinued titles, anime, and specialty releases can be worth extra attention."],
                ].map(([number, title, body]) => (
                  <div key={number} className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    <div className="flex gap-4">
                      <div className="flex h-10 w-10 flex-none items-center justify-center rounded-full bg-blue-500 font-bold">{number}</div>
                      <div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[.95fr_1.05fr] gap-10 items-center">
            <div className="rounded-3xl border border-gray-200 bg-slate-50 p-7 sm:p-8 order-2 lg:order-1">
              <div className="space-y-4">
                {["Pull out unusual box sets, steelbooks, complete series, and collector editions", "Scan the ordinary titles by UPC instead of researching every movie manually", "Keep qualifying items together and separate damaged or incomplete discs before packing", "Combine accepted DVDs with Blu-rays, 4K movies, books, CDs, and games in the same order"].map((item) => (
                  <div key={item} className="flex gap-3 text-gray-700">
                    <span className="mt-0.5 text-green-600"><CheckIcon /></span>
                    <span>{item}</span>
                  </div>
            ...
            <div className="order-1 lg:order-2">
              <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Clearing a movie collection?</p>
              <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">You Don&apos;t Need to List Every DVD One at a Time</h2>
              <p className="mt-5 text-lg leading-relaxed text-gray-600">A shelf or several boxes of movies can become hundreds of separate jobs if every title needs research, photos, a listing, buyer messages, and an individual shipment. Barcode scanning gives you a faster way to sort the collection and decide where your time is worth spending.</p>
              <div className="mt-7 flex flex-wrap gap-3">
                <Link href="/guides/what-to-do-with-old-dvds-and-cds" className="inline-flex items-center rounded-xl bg-blue-600 px-6 py-3 font-bold text-white hover:bg-blue-700 transition-colors">What to Do With Old DVDs &amp; CDs →</Link>
                <Link href="/guides/best-places-to-sell-cds-dvds-games" className="inline-flex items-center rounded-xl border border-gray-300 bg-white px-6 py-3 font-bold text-gray-800 hover:border-blue-300 hover:text-blue-700 transition-colors">Compare Selling Options →</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Choose the workflow that fits you</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">Sell Directly vs. List Every Movie on a Marketplace</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">Individual selling can make sense for a truly collectible title. A direct buyback is designed for convenience when you want to move through a larger group of ordinary used media.</p>
          </div>
          ...
          <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
            ...
            {[
              ["Offer", "See the current buyback offer before shipping", "Choose a listing price and wait for a buyer"],
              ["Photos & descriptions", "No individual product listing", "Usually needed for each item"],
              ["Buyer messages", "No buyer negotiation", "May require questions and communication"],
              ["Shipping", "Accepted items can ship together with a prepaid label", "Often handled sale by sale"],
              ["Seller fees", "No seller fees charged by SellBookMedia", "Platform fees may apply"],
              ["Best fit", "Convenient for clearing multiple eligible titles", "Can make sense for rare or high-value collectibles"],
          ...
          <p className="mt-5 text-sm text-gray-500 text-center">For genuinely rare or collectible releases, it can be worth checking collector-market sales before choosing any bulk buyback option.</p>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Straightforward by design</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">Why Sell DVDs to SellBookMedia?</h2>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-gray-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-8 sm:p-10">
            <div className="grid lg:grid-cols-[1.1fr_.9fr] gap-10 items-center">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Cleaning out more than movies?</p>
                <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">One Order Can Include More Than DVDs</h2>
                <p className="mt-5 text-lg leading-relaxed text-gray-600">Accepted DVDs, Blu-rays, and 4K movies can be combined with qualifying books, CDs, and video games in the same order. That makes it easier to clear a mixed media collection without creating separate transactions.</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <Link href="/sell-cds-for-cash" className="rounded-2xl border border-blue-100 bg-white p-5 hover:border-blue-300 hover:shadow-sm transition-all">
                  <div className="text-3xl">💿</div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-600">Helpful before you sell</p>
            <h2 className="mt-3 text-3xl sm:text-4xl font-bold text-gray-900">DVD, Blu-ray &amp; 4K Selling Guides</h2>
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">Go deeper on movie value, exact-release barcodes, older DVDs, collection clean-outs, and different ways to sell physical media.</p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              ...
              <p className="mt-2 text-sm leading-relaxed text-gray-600">Learn what SellBookMedia buys and why we focus on helping physical media find another useful life.</p>
              <Link href="/about" className="inline-flex mt-4 font-semibold text-blue-600 hover:text-blue-800">About SellBookMedia →</Link>
            </div>

            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <h3 className="font-bold text-gray-900 text-lg">Need help before shipping?</h3>
              <p className="mt-2 text-sm leading-relaxed text-gray-600">Check common questions about selling, shipping, account details, and the order process.</p>
              <Link href="/help" className="inline-flex mt-4 font-semibold text-blue-600 hover:text-blue-800">Visit Help Center →</Link>
            </div>

            <div className="rounded-2xl border border-gray-200 bg-white p-6">
              <h3 className="font-bold text-gray-900 text-lg">Review our policies</h3>
              <p className="mt-2 text-sm leading-relaxed text-gray-600">Read the returns policy and seller terms before submitting an order if you want the full details.</p>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-600">What to know before selling DVDs, Blu-rays, and 4K movies for cash online</p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        <div className="absolute inset-0 bg-black/20" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.18em] text-blue-200">Have a movie within reach?</p>
          <h2 className="mt-3 text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">See What Your DVD Is Worth</h2>
          <p className="text-xl sm:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed">Scan the barcode and see whether we&apos;re currently buying that exact DVD, Blu-ray, or 4K release.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-1">
              <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-4 block">SellBookMedia</Link>
              <p className="text-gray-400 leading-relaxed mb-6">We buy used books, CDs, DVDs, Blu-rays, 4K movies, and games for cash.</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/guides/how-much-are-used-dvds-worth" className="text-gray-400 hover:text-white transition-colors">How Much Are Used DVDs Worth?</Link></li>
                <li><Link href="/guides/are-old-dvds-worth-anything" className="text-gray-400 hover:text-white transition-colors">Are Old DVDs Worth Anything?</Link></li>
